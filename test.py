...
def eval():
    ...
    test_dir = 'G:\\pyproworkspace\\Cats_vs_Dogs-master\\data\\test'
    logs_dir = 'logs_1'     # 检查点目录
    test_picture = 'mmm.jpg'

    sess = tf.Session()

    train_list = get_all_files(test_dir, is_random=True)
    image_train_batch, label_train_batch = get_batch(train_list, IMG_SIZE, BATCH_SIZE, CAPACITY, True, test_picture)
